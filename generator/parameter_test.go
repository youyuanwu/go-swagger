	...
	fixtureConfig := map[string]map[string][]string{
		"1": { // fixture index
			"serverParameter": { // executed template
				...
				`if err := o.validateNotAnOption1(ctx, formats); err != nil {`,
				...
				`if err := o.validateNotAnOption2(ctx, formats); err != nil {`,
		...
		"3": {
			"serverParameter": {
				...
				`if err := o.validateIsAnOption4(ctx, formats); err != nil {`,
				...
				`if err := o.validateIsAnOptionalHeader(ctx, formats); err != nil {`,
	...
	fixtureConfig := map[string]map[string][]string{
		...
		"2": { // fixture index
			"serverParameter": { // executed template
				...
				`			o.MyObject = body`,
				`			if err := o.validateMyObjectBody(ctx, route.Formats); err != nil {`,
				`				res = append(res, err)`,
				`	if len(res) > 0 {`,
				`		return errors.CompositeValidationError(res...)`,
				`func (o *PostBodybuilder20Params) validateMyObjectBody(ctx context.Context, formats strfmt.Registry) error {`,
				`	// uniqueItems: true`,
		...
		"3": { // fixture index
			"serverParameter": { // executed template
				...
				`		return errors.CompositeValidationError(res...)`,
				`	return nil`,
				`func (o *PostBodybuilder26Params) validateMyObjectBody(ctx context.Context, formats strfmt.Registry) error {`,
		...
		"4": { // fixture index
			"serverParameter": { // executed template
				...
				`	if len(res) > 0 {`,
				`		return errors.CompositeValidationError(res...)`,
				`func (o *PostBodybuilder27Params) validateMyObjectBody(ctx context.Context, formats strfmt.Registry) error {`,
		...
		"5": { // fixture index
			"serverParameter": { // executed template
				...
				// changed index
				`			for i := range body {`,
				`				if err := body[i].Validate(ctx, route.Formats); err != nil {`,
				`					res = append(res, err)`,
				`					break`,
	...
	fixtureConfig := map[string]map[string][]string{
		...
		"getNestedWithValidations": { // fixture index
			"serverParameter": { // executed template
				...
				`			if err := o.validateGenericNestedWithValidationsBody(ctx, route.Formats); err != nil {`,
				`		return errors.CompositeValidationError(res...`,
				`func (o *GetNestedWithValidationsParams) validateGenericNestedWithValidationsBody(ctx context.Context, formats strfmt.Registry) error {`,
		...
		"getNestedRequired": { // fixture index
			"serverParameter": { // executed template
				...
				`			if err := o.validateObjectNestedRequiredBody(ctx, route.Formats); err != nil {`,
				`		return errors.CompositeValidationError(res...`,
				`func (o *GetNestedRequiredParams) validateObjectNestedRequiredBody(ctx context.Context, formats strfmt.Registry) error {`,
				...
				`								if err := objectNestedRequiredIIII.Validate(ctx, formats); err != nil {`,
		...
		"getRecordsMax": { // fixture index
			"serverParameter": { // executed template
				...
				`		} else {`,
				`			o.MaxRecords = body`,
				`			if err := o.validateMaxRecordsBody(ctx, route.Formats); err != nil {`,
				`	} else {`,
				`		res = append(res, errors.Required("maxRecords", "body", "")`,
				`		return errors.CompositeValidationError(res...`,
				`func (o *GetRecordsMaxParams) validateMaxRecordsBody(ctx context.Context, formats strfmt.Registry) error {`,
	...
	fixtureConfig := map[string]map[string][]string{
		...
		"getSimpleArrayWithSliceValidation": { // fixture index
			"serverParameter": { // executed template
				...
				`			if err := o.validateSimpleArrayWithSliceValidationBody(ctx, route.Formats); err != nil {`,
				`		return errors.CompositeValidationError(res...`,
				`func (o *GetSimpleArrayWithSliceValidationParams) validateSimpleArrayWithSliceValidationBody(ctx context.Context, formats strfmt.Registry) error {`,
		...
		"getSimpleArrayWithValidation": { // fixture index
			"serverParameter": { // executed template
				...
				`			if err := o.validateSimpleArrayWithValidationBody(ctx, route.Formats); err != nil {`,
				`		return errors.CompositeValidationError(res...`,
				`func (o *GetSimpleArrayWithValidationParams) validateSimpleArrayWithValidationBody(ctx context.Context, formats strfmt.Registry) error {`,
	...
	fixtureConfig := map[string]map[string][]string{
		...
		"getMapArrayWithMax": { // fixture index
			"serverParameter": { // executed template
				...
				`			for k := range body {`,
				`				if val, ok := body[k]; ok {`,
				`				if err := val.Validate(ctx, route.Formats); err != nil {`,
				`					break`,
				`			if len(res) == 0 {`,
		...
		"getArrayNestedSimple": { // fixture index
			"serverParameter": { // executed template
				...
				`			if err := o.validateArrayOfarraySimpleBody(ctx, route.Formats); err != nil {`,
				`	} else {`,
				`		res = append(res, errors.Required("arrayOfarraySimple", "body", "")`,
				`		return errors.CompositeValidationError(res...`,
				`func (o *GetArrayNestedSimpleParams) validateArrayOfarraySimpleBody(ctx context.Context, formats strfmt.Registry) error {`,
		...
		"getMapOfFormat": { // fixture index
			"serverParameter": { // executed template
				...
				`		} else {`,
				`			o.MapOfFormat = body`,
				`			if err := o.validateMapOfFormatBody(ctx, route.Formats); err != nil {`,
				`	} else {`,
				`		res = append(res, errors.Required("mapOfFormat", "body", "")`,
				`		return errors.CompositeValidationError(res...`,
				`func (o *GetMapOfFormatParams) validateMapOfFormatBody(ctx context.Context, formats strfmt.Registry) error {`,
		...
		"getArrayOfMap": { // fixture index
			"serverParameter": { // executed template
				...
				`		} else {`,
				`			o.ArrayOfMap = body`,
				`			if err := o.validateArrayOfMapBody(ctx, route.Formats); err != nil {`,
				`	} else {`,
				`		res = append(res, errors.Required("arrayOfMap", "body", "")`,
				`		return errors.CompositeValidationError(res...`,
				`func (o *GetArrayOfMapParams) validateArrayOfMapBody(ctx context.Context, formats strfmt.Registry) error {`,
		...
		"getArrayNested": { // fixture index
			"serverParameter": { // executed template
				...
				`		} else {`,
				`			o.ArrayOfarray = body`,
				`			if err := o.validateArrayOfarrayBody(ctx, route.Formats); err != nil {`,
				`	} else {`,
				`		res = append(res, errors.Required("arrayOfarray", "body", "")`,
				`		return errors.CompositeValidationError(res...`,
				`func (o *GetArrayNestedParams) validateArrayOfarrayBody(ctx context.Context, formats strfmt.Registry) error {`,
				...
				`					if err := arrayOfarrayII.Validate(ctx, formats); err != nil {`,
				`						if ve, ok := err.(*errors.Validation); ok {`,
		...
		"getMapAnonArrayWithNullable": { // fixture index
			"serverParameter": { // executed template
				...
				`			if err := o.validateMapOfAnonArrayWithNullableBody(ctx, route.Formats); err != nil {`,
				`	} else {`,
				`		res = append(res, errors.Required("mapOfAnonArrayWithNullable", "body", "")`,
				`		return errors.CompositeValidationError(res...`,
				`func (o *GetMapAnonArrayWithNullableParams) validateMapOfAnonArrayWithNullableBody(ctx context.Context, formats strfmt.Registry) error {`,
		...
		"getMapOfAnonArray": { // fixture index
			"serverParameter": { // executed template
				...
				`			if err := o.validateMapOfAnonArrayBody(ctx, route.Formats); err != nil {`,
				`	} else {`,
				`		res = append(res, errors.Required("mapOfAnonArray", "body", "")`,
				`		return errors.CompositeValidationError(res...`,
				`func (o *GetMapOfAnonArrayParams) validateMapOfAnonArrayBody(ctx context.Context, formats strfmt.Registry) error {`,
		...
		"getMapOfAnonMap": { // fixture index
			"serverParameter": { // executed template
				...
				`		} else {`,
				`			o.MapOfAnonMap = body`,
				`			if err := o.validateMapOfAnonMapBody(ctx, route.Formats); err != nil {`,
				`	} else {`,
				`		res = append(res, errors.Required("mapOfAnonMap", "body", "")`,
				`		return errors.CompositeValidationError(res...`,
				`func (o *GetMapOfAnonMapParams) validateMapOfAnonMapBody(ctx context.Context, formats strfmt.Registry) error {`,
		...
		"getMapAnonArray": { // fixture index
			"serverParameter": { // executed template
				...
				`		res = append(res, errors.Required("mapOfAnonArray", "body", "")`,
				`		return errors.CompositeValidationError(res...`,
				`func (o *GetMapAnonArrayParams) validateMapOfAnonArrayBody(ctx context.Context, formats strfmt.Registry) error {`,
				`	mapOfAnonArrayIC := o.MapOfAnonArray`,
				`	mapOfAnonArrayIR := make(map[string][]int64, len(mapOfAnonArrayIC)`,
				`	for k, mapOfAnonArrayIV := range mapOfAnonArrayIC {`,
				`		mapOfAnonArrayIIC := mapOfAnonArrayIV`,
		...
		"getMapOfPrimitive": { // fixture index
			"serverParameter": { // executed template
				...
				`			if err := o.validateMapOfPrimitiveBody(ctx, route.Formats); err != nil {`,
				`	} else {`,
				`		res = append(res, errors.Required("mapOfPrimitive", "body", "")`,
				`		return errors.CompositeValidationError(res...`,
				`func (o *GetMapOfPrimitiveParams) validateMapOfPrimitiveBody(ctx context.Context, formats strfmt.Registry) error {`,
		...
		"getMapOfMap": { // fixture index
			"serverParameter": { // executed template
				...
				`		} else {`,
				`			o.MapOfMap = body`,
				`			if err := o.validateMapOfMapBody(ctx, route.Formats); err != nil {`,
				`	} else {`,
				`		res = append(res, errors.Required("mapOfMap", "body", "")`,
				`		return errors.CompositeValidationError(res...`,
				`func (o *GetMapOfMapParams) validateMapOfMapBody(ctx context.Context, formats strfmt.Registry) error {`,
				...
				`			if err := mapOfMapII.Validate(ctx, formats); err != nil {`,
				`				if ve, ok := err.(*errors.Validation); ok {`,
	...
	fixtureConfig := map[string]map[string][]string{
		...
		"getMapOfArrayOfMap": { // fixture index
			"serverParameter": { // executed template
				...
				`			if err := o.validateMapOfArrayOfMapBody(ctx, route.Formats); err != nil {`,
				`	} else {`,
				`		res = append(res, errors.Required("mapOfArrayOfMap", "body", "")`,
				`		return errors.CompositeValidationError(res...`,
				`func (o *GetMapOfArrayOfMapParams) validateMapOfArrayOfMapBody(ctx context.Context, formats strfmt.Registry) error {`,
		...
		"getMapOfArrayOfNullableMap": { // fixture index
			"serverParameter": { // executed template
				...
				`			if err := o.validateMapOfArrayOfNullableMapBody(ctx, route.Formats); err != nil {`,
				`	} else {`,
				`		res = append(res, errors.Required("mapOfArrayOfNullableMap", "body", "")`,
				`		return errors.CompositeValidationError(res...`,
				`func (o *GetMapOfArrayOfNullableMapParams) validateMapOfArrayOfNullableMapBody(ctx context.Context, formats strfmt.Registry) error {`,
				...
				`			if err := mapOfArrayOfNullableMapII.Validate(ctx, formats); err != nil {`,
				`				if ve, ok := err.(*errors.Validation); ok {`,
		...
		"getMapArrayOfArray": { // fixture index
			"serverParameter": { // executed template
				...
				`			if err := o.validateMapOfArrayOfArrayBody(ctx, route.Formats); err != nil {`,
				`	} else {`,
				`		res = append(res, errors.Required("mapOfArrayOfArray", "body", "")`,
				`		return errors.CompositeValidationError(res...`,
				`func (o *GetMapArrayOfArrayParams) validateMapOfArrayOfArrayBody(ctx context.Context, formats strfmt.Registry) error {`,
				...
				`					if err := mapOfArrayOfArrayIII.Validate(ctx, formats); err != nil {`,
				`						if ve, ok := err.(*errors.Validation); ok {`,
		...
		"getMapAnonArrayWithNestedNullable": { // fixture index
			"serverParameter": { // executed template
				...
				`			if err := o.validateMapOfAnonArrayWithNestedNullableBody(ctx, route.Formats); err != nil {`,
				`	} else {`,
				`		res = append(res, errors.Required("mapOfAnonArrayWithNestedNullable", "body", "")`,
				`		return errors.CompositeValidationError(res...`,
				`func (o *GetMapAnonArrayWithNestedNullableParams) validateMapOfAnonArrayWithNestedNullableBody(ctx context.Context, formats strfmt.Registry) error {`,
	...
	fixtureConfig := map[string]map[string][]string{
		...
		"getNestedSliceAndMap01": { // fixture index
			"serverParameter": { // executed template
				...
				`			if err := o.validateNestedSliceAndMap01Body(ctx, route.Formats); err != nil {`,
				`	} else {`,
				`		res = append(res, errors.Required("nestedSliceAndMap01", "body", "")`,
				`		return errors.CompositeValidationError(res...`,
				`func (o *GetNestedSliceAndMap01Params) validateNestedSliceAndMap01Body(ctx context.Context, formats strfmt.Registry) error {`,
		...
		"getNestedMapAndSlice02": { // fixture index
			"serverParameter": { // executed template
				...
				`			if err := o.validateNestedMapAndSlice02Body(ctx, route.Formats); err != nil {`,
				`	} else {`,
				`		res = append(res, errors.Required("nestedMapAndSlice02", "body", "")`,
				`		return errors.CompositeValidationError(res...`,
				`func (o *GetNestedMapAndSlice02Params) validateNestedMapAndSlice02Body(ctx context.Context, formats strfmt.Registry) error {`,
		...
		"getNestedSliceAndMap03": { // fixture index
			"serverParameter": { // executed template
				...
				`			if err := o.validateNestedSliceAndMap03Body(ctx, route.Formats); err != nil {`,
				`	} else {`,
				`		res = append(res, errors.Required("nestedSliceAndMap03", "body", "")`,
				`		return errors.CompositeValidationError(res...`,
				`func (o *GetNestedSliceAndMap03Params) validateNestedSliceAndMap03Body(ctx context.Context, formats strfmt.Registry) error {`,
		...
		"getNestedArray04": { // fixture index
			"serverParameter": { // executed template
				...
				`		} else {`,
				`			o.NestedArray03 = body`,
				`			if err := o.validateNestedArray03Body(ctx, route.Formats); err != nil {`,
				`	} else {`,
				`		res = append(res, errors.Required("nestedArray03", "body", "")`,
				`		return errors.CompositeValidationError(res...`,
				`func (o *GetNestedArray04Params) validateNestedArray03Body(ctx context.Context, formats strfmt.Registry) error {`,
		...
		"getNestedMapAndSlice01": { // fixture index
			"serverParameter": { // executed template
				...
				`			if err := o.validateNestedMapAndSlice01Body(ctx, route.Formats); err != nil {`,
				`	} else {`,
				`		res = append(res, errors.Required("nestedMapAndSlice01", "body", "")`,
				`		return errors.CompositeValidationError(res...`,
				`func (o *GetNestedMapAndSlice01Params) validateNestedMapAndSlice01Body(ctx context.Context, formats strfmt.Registry) error {`,
		...
		"getNestedMap02": { // fixture index
			"serverParameter": { // executed template
				...
				`		} else {`,
				`			o.NestedMap02 = body`,
				`			if err := o.validateNestedMap02Body(ctx, route.Formats); err != nil {`,
				`	} else {`,
				`		res = append(res, errors.Required("nestedMap02", "body", "")`,
				`		return errors.CompositeValidationError(res...`,
				`func (o *GetNestedMap02Params) validateNestedMap02Body(ctx context.Context, formats strfmt.Registry) error {`,
		...
		"getNestedMapAndSlice03": { // fixture index
			"serverParameter": { // executed template
				...
				`			if err := o.validateNestedMapAndSlice03Body(ctx, route.Formats); err != nil {`,
				`	} else {`,
				`		res = append(res, errors.Required("nestedMapAndSlice03", "body", "")`,
				`		return errors.CompositeValidationError(res...`,
				`func (o *GetNestedMapAndSlice03Params) validateNestedMapAndSlice03Body(ctx context.Context, formats strfmt.Registry) error {`,
		...
		"getNestedSliceAndMap02": { // fixture index
			"serverParameter": { // executed template
				...
				`			if err := o.validateNestedSliceAndMap02Body(ctx, route.Formats); err != nil {`,
				`	} else {`,
				`		res = append(res, errors.Required("nestedSliceAndMap02", "body", "")`,
				`		return errors.CompositeValidationError(res...`,
				`func (o *GetNestedSliceAndMap02Params) validateNestedSliceAndMap02Body(ctx context.Context, formats strfmt.Registry) error {`,
		...
		"getNestedMap01": { // fixture index
			"serverParameter": { // executed template
				...
				`		} else {`,
				`			o.NestedMap01 = body`,
				`			if err := o.validateNestedMap01Body(ctx, route.Formats); err != nil {`,
				`	} else {`,
				`		res = append(res, errors.Required("nestedMap01", "body", "")`,
				`		return errors.CompositeValidationError(res...`,
				`func (o *GetNestedMap01Params) validateNestedMap01Body(ctx context.Context, formats strfmt.Registry) error {`,
		...
		"getNestedArray01": { // fixture index
			"serverParameter": { // executed template
				...
				`			if err := o.validateNestedArray01Body(ctx, route.Formats); err != nil {`,
				`	} else {`,
				`		res = append(res, errors.Required("nestedArray01", "body", "")`,
				`		return errors.CompositeValidationError(res...`,
				`func (o *GetNestedArray01Params) validateNestedArray01Body(ctx context.Context, formats strfmt.Registry) error {`,
		...
		"getNestedArray02": { // fixture index
			"serverParameter": { // executed template
				...
				`		res = append(res, errors.Required("nestedArray01", "body", "")`,
				`		return errors.CompositeValidationError(res...`,
				`func (o *GetNestedArray02Params) validateNestedArray01Body(ctx context.Context, formats strfmt.Registry) error {`,
				`	nestedArray01Size := int64(len(o.NestedArray01)`,
				`	if err := validate.MaxItems("nestedArray01", "body", nestedArray01Size, 10); err != nil {`,
				`	nestedArray01IC := o.NestedArray01`,
		...
		"getNestedRefNoValidation02": { // fixture index
			"serverParameter": { // executed template
				...
				`			if err := o.validateNestedRefNovalidation02Body(ctx, route.Formats); err != nil {`,
				`		return errors.CompositeValidationError(res...`,
				`func (o *GetNestedRefNoValidation02Params) validateNestedRefNovalidation02Body(ctx context.Context, formats strfmt.Registry) error {`,
				...
				`			if err := nestedRefNovalidation02II.Validate(ctx, formats); err != nil {`,
				`				if ve, ok := err.(*errors.Validation); ok {`,
	...
	fixtureConfig := map[string]map[string][]string{
		...
		"getNestedRequired": { // fixture index
			...
			"serverOperation": { // executed template
				...
				`func (o *GetNestedRequiredParamsBodyItems0) Validate(ctx context.Context, formats strfmt.Registry) error {`,
				`	if err := o.validatePkcs(ctx, formats); err != nil {`,
				`		return errors.CompositeValidationError(res...`,
				`func (o *GetNestedRequiredParamsBodyItems0) validatePkcs(ctx context.Context, formats strfmt.Registry) error {`,
	...
	fixtureConfig := map[string]map[string][]string{
		...
		"MyMethod": { // fixture index
			"serverParameter": { // executed template
				...
				`	if err := o.validateByteInQuery(ctx, formats); err != nil {`,
				`func (o *MyMethodParams) validateByteInQuery(ctx context.Context, formats strfmt.Registry) error {`,
	...
	fixtureConfig := map[string]map[string][]string{
		...
		"getPrimitive": { // fixture index
			"serverParameter": { // executed template
				...
				`			if err := o.validatePrimitiveBodyBody(ctx, route.Formats); err != nil {`,
				`	} else {`,
				`		res = append(res, errors.Required("primitiveBody", "body", "")`,
				`		return errors.CompositeValidationError(res...`,
				`func (o *GetPrimitiveParams) validatePrimitiveBodyBody(ctx context.Context, formats strfmt.Registry) error {`,
